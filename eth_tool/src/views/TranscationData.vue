...
const parseType = ref('transcation');
...
<template>
  <v-container>
    ...
    <h2>Data</h2>
    <v-textarea label="" rows="3" variant="outlined" v-model="data"></v-textarea>

    <v-select v-model="parseType" :items="['transcation', 'log', 'error']" label="Type" required></v-select>
